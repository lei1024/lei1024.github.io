import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as i,e as l}from"./app-BAORXNoS.js";const t={},a=l(`<h1 id="在jetbrains全家桶中使用ideavim" tabindex="-1"><a class="header-anchor" href="#在jetbrains全家桶中使用ideavim" aria-hidden="true">#</a> 在Jetbrains全家桶中使用ideavim</h1><h3 id="_1-安装必备的一些插件" tabindex="-1"><a class="header-anchor" href="#_1-安装必备的一些插件" aria-hidden="true">#</a> 1.安装必备的一些插件</h3><blockquote><p>AceJump</p></blockquote><blockquote><p>IdeaVim-EasyMotion、IdeaVim-Quickscope、IdeaVim-Sneak、IdeaVimExtension、Which-Key</p></blockquote><h3 id="_2-ideavim配置文件-ideavimrc" tabindex="-1"><a class="header-anchor" href="#_2-ideavim配置文件-ideavimrc" aria-hidden="true">#</a> 2.ideavim配置文件 .ideavimrc</h3><div class="language-ini line-numbers-mode" data-ext="ini"><pre class="language-ini"><code>&quot;:actionlist 可以查询所有的命令
